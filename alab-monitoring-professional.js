...
<script>
    // Nur ARIA-Feedback für Hover/Focus (Öffnen läuft per CSS)
    (function(){
    ...
    // Link-Targeting für iFrame-Usecase: interne Links im selben Tab/_top, externe im neuen Tab
    (function(){
      ...
      new MutationObserver(m=>m.forEach(x=>x.addedNodes.forEach(node=>{
